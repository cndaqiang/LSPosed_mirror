...
echo -e "<a href=\"https://cndaqiang.github.io/LSPosed_mirror/\">github</a><br>" >> $index  
echo -e "<a href=\"http://blog.cndaqiang.workers.dev/LSPosed_mirror/\">cloudflare&github</a><br>" >> $index  
#
